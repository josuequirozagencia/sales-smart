const messages = {
  es: {
    translations: {
      ...
      messagesList: {
        ventana24h: "Tienes 24 h para responder desde que el cliente escribe, según las políticas de Meta.",
        header: {
      ...
      whatsappTemplates: {
        ...
        help: "Catálogo real de plantillas aprobadas por Meta para cada conexión. Es de solo lectura: las plantillas se crean y se editan en Meta (o en GoHighLevel).",
        connection: "Conexión",
        search: "Buscar plantilla",
        refresh: "Volver a cargar desde Meta",
        noConnections: "No hay conexiones de WhatsApp Oficial ni de GoHighLevel. Las conexiones por QR no tienen plantillas de Meta.",
        empty: "Esta conexión no tiene plantillas.",
        table: {
          name: "Nombre",
          language: "Idioma",
          category: "Categoría",
        ...
        errors: {
          generic: "No se pudieron leer las plantillas.",
        },
      },
      aiAgentControl: {
        label: "Agente IA",
      ...
      backendErrors: {
        ...
        ERR_TEMPLATES_META_REJECTED: "Meta rechazó las credenciales: revisa el ID de la cuenta de WhatsApp Business y el token en GoHighLevel.",
